...
; motor on if not already on, reset motor timer 
tmoton			lda 	porta
			and	#8
			beq	_tm
			jsr	motor_on
...
; drive startup sequence (trk0, 10 steps, restore) aka 'bzium' (tm)
...
;
; make half a step
; the step motor runs a cycle of 4 phases, equal to 2 tracks
;
